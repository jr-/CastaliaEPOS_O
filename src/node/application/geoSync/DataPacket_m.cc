...
DataPacket::DataPacket(const char *name, int kind) : ::GeoSyncPacketType(name,kind)
{
}

DataPacket::DataPacket(const DataPacket& other) : ::GeoSyncPacketType(other)
{
    copy(other);
}
...
DataPacketDescriptor::DataPacketDescriptor() : cClassDescriptor("DataPacket", "GeoSyncPacketType")
{
}
