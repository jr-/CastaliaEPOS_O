#
# OMNeT++/OMNEST Makefile for castaliaOriginal
#
...
TARGET = castaliaOriginal$(EXE_SUFFIX)
...
INCLUDE_PATH = \
    ...
    -ISimulations/Parameters/nodeMap \
...
clean:
	$(qecho) Cleaning...
	$(Q)-rm -rf $O
	$(Q)-rm -f castaliaOriginal castaliaOriginal.exe libcastaliaOriginal.so libcastaliaOriginal.a libcastaliaOriginal.dll libcastaliaOriginal.dylib
	$(Q)-rm -f ./*_m.cc ./*_m.h
	...
	$(Q)-rm -f Simulations/Parameters/nodeMap/*_m.cc Simulations/Parameters/nodeMap/*_m.h
